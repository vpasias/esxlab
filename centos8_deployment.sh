...
ssh -o "StrictHostKeyChecking=no" centos@node0 "sudo yum install epel-next-release -y"
ssh -o "StrictHostKeyChecking=no" centos@node0 "sudo yum install ansible -y"
